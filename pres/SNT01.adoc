...
image::https://thumb.wikimedia.org/wikipedia/commons/thumb/e/e0/Hotel_Baron_thermometer.jpg/250px-Hotel_Baron_thermometer.jpg?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=thumbnail[alt]
...
image::https://images.math.cnrs.fr/freeze/img/png/section1-original-zoom.png[]
...
image::https://images.math.cnrs.fr/freeze/img/png/section8-image.png[]
image::https://images.math.cnrs.fr/freeze/img/png/section8-rouge.png[]

=== !

image::https://images.math.cnrs.fr/freeze/img/png/section8-vert.png[]
image::https://images.math.cnrs.fr/freeze/img/png/section8-bleu.png[]


=== Synthèse additive

image::https://images.math.cnrs.fr/freeze/img/png/section8-synthese-additive.png[]

== Ecran

Un écran est composé de pixel.

image::https://thumb.wikimedia.org/wikipedia/commons/thumb/b/b7/Cell_Phone_screen_Pixels.jpg/250px-Cell_Phone_screen_Pixels.jpg[]
